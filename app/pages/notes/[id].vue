...
<template>
  <div class="flex-1 overflow-y-auto">
    <div v-if="note" class="max-w-3xl mx-auto px-6 py-12">
      <NuxtLink to="/notes" class="text-sm text-(--fg-muted) hover:text-(--accent)">← All notes</NuxtLink>
    ...
    <div v-else-if="notFound" class="flex flex-col items-center justify-center py-24">
      ...
      <NuxtLink to="/notes" class="text-sm text-(--accent) mt-2">Back to notes</NuxtLink>
    </div>
